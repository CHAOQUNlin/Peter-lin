    ...
    function renderStoryDetail(storyId) {
        ...
        processedContent = processedContent.replace(imagePlaceholderRegex, (match, indices) => {
            ...
            if (validImages.length === 2) {
                return `<div class="grid-2-col" style="margin: 2rem 0; display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem;">
                    ${validImages.map(img => {
            ...
            return `<div class="grid-3-col" style="margin: 2rem 0; display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
                ${validImages.map(img => {
                const encodedSrc = encodeImagePath(img.src);
                return `
        ...
        function renderUnusedImages(images) {
            ...
            while (i < uniqueImages.length) {
                ...
                if (remaining >= 3) {
                    ...
                    html += `<div class="grid-3-col" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; margin-bottom: 1.5rem;">
                    ...
                    html += `<div class="grid-2-col" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem; margin-bottom: 1.5rem;">
